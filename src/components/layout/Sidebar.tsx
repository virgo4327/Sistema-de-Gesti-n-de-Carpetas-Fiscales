...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#0B0E14] border-r border-[#1E293B] flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-[#1E293B]">
        <button 
          ...
          className="flex items-center gap-3 px-4 py-3 w-full text-slate-400 hover:bg-red-500/10 hover:text-red-400 rounded-xl transition-all group"
        >
